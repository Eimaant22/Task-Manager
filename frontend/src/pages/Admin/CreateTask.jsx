...
import { PRIORITY_DATA } from "../../utils/data.jsx";
...
import AddAttachmentsInput from "../../components/AddAttachmentsInput.jsx";
import DeleteAlert from "../../components/DeleteAlert.jsx";

const CreateTask = () => {
  const location = useLocation();
  const { taskId } = location.state || {}; //taskId is destructured globally here can be assessed by any function below
  ...
  // ✅ Get Task by ID (Reusable Version)
  ...
  return (
    <DashboardLayout activeMenu="Dashboard">
      ...
      >
        <DeleteAlert onDelete={deleteTask} />
      </Modal>
    </DashboardLayout>
  );
};
